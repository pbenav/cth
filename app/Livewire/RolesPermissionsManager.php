...
class RolesPermissionsManager extends Component
{
    ...
    public function editRole($roleId)
    {
        ...
        if ($role->team_id !== $this->team->id && !Auth::user()->is_admin) {
            $this->dispatch('alertFail', ['message' => __('Unauthorized action')]);
            return;
        }
    ...
    public function saveRole()
    {
        ...
        try {
            ...
            $this->dispatch('alertFail', ['message' => 'Error de validación: ' . implode(', ', $e->validator->errors()->all())]);
            return;
        }
        ...
        try {
            ...
            $this->dispatch('alertFail', ['message' => $e->getMessage()]);
        }
    }
    ...
    public function deleteRole($roleId)
    {
        ...
        if ($role->is_system) {
            $this->dispatch('alertFail', ['message' => __('Cannot delete system roles')]);
            return;
        }
    ...
    public function editPermission($permissionId)
    {
        ...
        if ($permission->is_system && !Auth::user()->is_admin) {
            $this->dispatch('alertFail', ['message' => __('Cannot edit system permissions')]);
            return;
        }
    ...
    public function deletePermission($permissionId)
    {
        ...
        if ($permission->is_system) {
            $this->dispatch('alertFail', ['message' => __('Cannot delete system permissions')]);
            return;
        }
