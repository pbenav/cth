        ...
        <div class="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="flex items-center gap-4 border-r border-white/10 pr-6 mr-2">
                    <a href="https://github.com/pbenav" target="_blank" title="GitHub" class="text-slate-400 hover:text-white transition-colors">
                    ...
                    <a href="https://gitlab.com/pbenav" target="_blank" title="GitLab" class="text-slate-400 hover:text-white transition-colors">
                        <svg class="h-5 w-5 fill-current" viewBox="0 0 24 24"><path d="M23.955 13.587l-1.342-4.135-2.664-8.189c-.135-.417-.724-.417-.86 0L16.425 9.452h-8.85l-2.664-8.189c-.135-.417-.724-.417-.86 0L1.387 9.452.045 13.587c-.11.34.01.711.306.925l11.65 8.458 11.648-8.458c.296-.214.416-.585.306-.925z"/></svg>
                    </a>
                </div>
