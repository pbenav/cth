<div wire:poll.5s="refreshCount">
    <a href="{{ route('messages') }}" class="relative inline-flex items-center p-1.5 rounded-md hover:bg-gray-50 hover:text-gray-700 text-gray-600 transition-colors duration-200">
