<x-legal-layout title="Términos de Servicio">
    ...
    @else
        ...
        <p class="mb-4">
            sientiaCTH es una plataforma integral de control horario diseñada para el registro eficiente de jornadas, turnos y control de presencia de equipos. El acceso a ciertas funciones puede requerir una cuenta de usuario activa.
        </p>

        <h2 class="text-xl font-bold text-gray-900 dark:text-white mt-8 mb-4">2. Registro y Responsabilidad de la Cuenta</h2>
        <p class="mb-4">Para utilizar sientiaCTH, debes cumplir con los siguientes requisitos:</p>
        ...
        <p class="mb-4">
            sientiaCTH se ofrece "tal cual" (as is). Aunque nos esforzamos por ofrecer un servicio ininterrumpido y de calidad, no nos hacemos responsables de:
        </p>
        <ul class="list-disc pl-5 mb-6 space-y-2">
